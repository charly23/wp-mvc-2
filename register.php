<?php if( ! function_exists( 'reqister_wp_mvc' ) or wp_die( 'register directory function call not exists' ) ) 
{

    function reqister_wp_mvc () 
    {
        ...
        **/ 
        ...
        $system = $system_load;
        define( __( $slugs, 'slug' ) . '_SYSTEMS', 'system' );
        ...
        **/ 
        ...
        $config = $config_load;
        define( __( $slugs, 'slug' ) . '_CONFIG', 'config' );
        if( is_array( $config ) ) :
        ...
        **/ 
        ...
        $helper = $helper_load;
        define( __( $slugs, 'slug' ) . '_HELPER', 'helper' );
        if( is_array( $helper ) ) :
        ...
        **/ 
        ...
        $model = $model_load;
        define( __( $slugs, 'slug' ) . '_MODEL', 'model' );
        if( is_array( $model ) ) :
        ...
        **/ 
        ...
        define( __( $slugs, 'slug' ) . '_CONTROLLER', 'controller' );
        if( is_array( $control ) ) :
